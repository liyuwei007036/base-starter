...
public enum ResponseEnums {
    ...
    A3GA("3ga", "video/3gpp"),
    A3GP("3gp", "video/3gpp"),
    A3GPP("3gpp", "video/3gpp"),
    A602("602", "application/x-t602"),
    A669("669", "audio/x-mod"),
    A7Z("7z", "application/x-7z-compressed"),
    A("a", "application/x-archive"),
    AAC("aac", "audio/mp4"),
    ABW("abw", "application/x-abiword"),
    ABWCRASHED("crashed", "application/x-abiword"),
    ...
    ACLASS("class", "application/x-java"),
    CLS("cls", "text/x-tex"),
    CMAKE("cmake", "text/x-cmake"),
    CPIO("cpio", "application/x-cpio"),
    CPIOGZ("cpio.gz", "application/x-cpio-compressed"),
    ...
    DVIBZ2("dvi.bz2", "application/x-bzdvi"),
    DVIGZ("dvi.gz", "application/x-gzdvi"),
    ...
    EPS("eps", "image/x-eps"),
    EPSBZ2("eps.bz2", "image/x-bzeps"),
    EPSGZ("eps.gz", "image/x-gzeps"),
    EPSF("epsf", "image/x-eps"),
    EPSFBZ2("epsf.bz2", "image/x-bzeps"),
    EPSFGZ("epsf.gz", "image/x-gzeps"),
    EPSI("epsi", "image/x-eps"),
    EPSIBZ2("epsi.bz2", "image/x-bzeps"),
    EPSIGZ("epsi.gz", "image/x-gzeps"),
    ...
    PCFGZ("pcf.gz", "application/x-font-pcf"),
    PCFZ("pcf.z", "application/x-font-pcf"),
    PCL("pcl", "application/vnd.hp-pcl"),
    PCX("pcx", "image/x-pcx"),
    PDB("pdb", "chemical/x-pdb"),
    PDC("pdc", "application/x-aportisdoc"),
    PDF("pdf", "application/pdf"),
    PDFBZ2("pdf.bz2", "application/x-bzpdf"),
    PDFGZ("pdf.gz", "application/x-gzpdf"),
    ...
    PSBZ2("ps.bz2", "application/x-bzpostscript"),
    PSGZ("ps.gz", "application/x-gzpostscript"),
    PSD("psd", "image/vnd.adobe.photoshop"),
    PSF("psf", "audio/x-psf"),
    PSFGZ("psf.gz", "application/x-gz-font-linux-psf"),
    ...
    TARBZ("tar.bz", "application/x-bzip-compressed-tar"),
    TARBZ2("tar.bz2", "application/x-bzip-compressed-tar"),
    TARGZ("tar.gz", "application/x-compressed-tar"),
    TARLZMA("tar.lzma", "application/x-lzma-compressed-tar"),
    TARLZO("tar.lzo", "application/x-tzo"),
    TARXZ("tar.xz", "application/x-xz-compressed-tar"),
    TARZ("tar.z", "application/x-tarz"),
    ...
    XCF("xcf", "image/x-xcf"),
    XCFBZ2("xcf.bz2", "image/x-compressed-xcf"),
    XCFGZ("xcf.gz", "image/x-compressed-xcf"),
    ...
    public static String getValue(String key) {
        String value = null;
        for (ResponseEnums s : ResponseEnums.values()) {
